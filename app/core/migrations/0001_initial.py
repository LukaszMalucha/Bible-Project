# Generated by Django 2.1.5 on 2020-06-20 17:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('book', models.CharField(blank=True, default='Not Specified', max_length=254)),
                ('chapter', models.IntegerField(default=0)),
                ('verse', models.IntegerField(default=0)),
                ('text', models.TextField(blank=True, default='Not Specified', max_length=254)),
            ],
            options={
